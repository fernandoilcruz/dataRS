#' geo_complement
#'
#' Complementary regionalizations for Health and Education
#'
#' @format A data frame
#' \describe{
#'   \item{CodIBGE}{IBGE Code}
...
#' }
#'
#' @source State secretariats at the government of state of Rio Grande do Sul
#'
#' @usage data(geo_complement)
"geo_complement"
